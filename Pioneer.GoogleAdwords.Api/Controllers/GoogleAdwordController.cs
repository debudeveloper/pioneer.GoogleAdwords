...
using Pioneer.GoogleAdwords.Api.EntityDataAccess;
using Pioneer.GoogleAdwords.Api.Models;
using System;
...
namespace Pioneer.GoogleAdwords.Api.Controllers
{
    [RoutePrefix("adwords/pioneer")]
    ...
    public class GoogleAdwordController : ApiController
    {
        ...
        public IHttpActionResult GetGoogleCampignPerformance(int productMasterId)
        {
            ...
            (user.Config as AdWordsAppConfig).ClientCustomerId = credential.ClientCustomerId;
            (user.Config as AdWordsAppConfig).DeveloperToken = credential.DeveloperToken;
            ...
            ReportDefinition definition = new ReportDefinition()
            {
                ...
                dateRangeType = ReportDefinitionDateRangeType.TODAY,
        ...
        private GoogleAdwordCredential getGoogleAdwordsCredentialByProductId(int productMasterId)
        {
            ...
            switch (productMasterId)
            {
                ...
                //    { siteid=2,
                // prodname ="Life"
                //        ClientCustomerId = "740-435-6551",
                //        DeveloperToken = "0Wf3sFhDmmahNnTxbynJfg",
                //        OAuth2ClientId = "215226543458-nd2eg32u4udlskt3ab8r1437mpim21is.apps.googleusercontent.com",
                //        OAuth2ClientSecret = "LFzx_vtGuRP-Fn_Mk9b6S1DU",
                //        OAuth2RefreshToken = "1/hmq7O1c8pObwH376sev5F0PZyu_X5pvLbLbcpVF7xbA"
                //    };
                case 55: //top mortgage
                    return credential = new GoogleAdwordCredential
                    {
                ...
                case 64: //top equity release
                    return credential = new GoogleAdwordCredential
                    {
                        WebSiteMasterId = 10,
                        ProductName = "Equity Release",
                        ClientCustomerId = "901-884-8822",
                        DeveloperToken = "0Wf3sFhDmmahNnTxbynJfg",
                        OAuth2ClientId = "215226543458-nd2eg32u4udlskt3ab8r1437mpim21is.apps.googleusercontent.com",
                        OAuth2ClientSecret = "LFzx_vtGuRP-Fn_Mk9b6S1DU",
                        OAuth2RefreshToken = "1/hmq7O1c8pObwH376sev5F0PZyu_X5pvLbLbcpVF7xbA"
                ...
                case 77: // injury claim
                    return credential = new GoogleAdwordCredential
                    {
                        WebSiteMasterId = 48,
                        ProductName = "Injury Claim",
                        ClientCustomerId = "572-788-9166",
                        DeveloperToken = "0Wf3sFhDmmahNnTxbynJfg",
                        OAuth2ClientId = "215226543458-nd2eg32u4udlskt3ab8r1437mpim21is.apps.googleusercontent.com",
                        OAuth2ClientSecret = "LFzx_vtGuRP-Fn_Mk9b6S1DU",
                        OAuth2RefreshToken = "1/hmq7O1c8pObwH376sev5F0PZyu_X5pvLbLbcpVF7xbA"
        ...
        public Tuple<int, string> getFilterProdValue(string url, GoogleAdwordCredential credential)
        {
            ...
            if (url.Contains("www.topmortgagedeal.co.uk/gbf/bridging-finance"))
            {
                return new Tuple<int, string>(50, "Bridging Finance");
            }
            if (url.Contains("www.bestmedicalplan.co.uk/gbu/business-medical-plan"))
            {
                return new Tuple<int, string>(31, "Corporate Health");
            }
            if (url.Contains("www.toploandeal.co.uk/gbl/bridging-loan"))
            {
                return new Tuple<int, string>(49, "Bridging Loan");
            }
